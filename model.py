...
def grouped_by_modules_and_packages(classes: list[Class]) -> dict[str:dict[str:Class]]:
    ...
    ...     Class(path="", name="View", raw_package="should.be.first", module="same.module"),
    ...
    ...     Class(path="", name="second", raw_package="same.package.b", module="same.module", package="same.package"),
    ...
    ...     Class(path="", name="second", raw_package="same.package", module="same.module"),
